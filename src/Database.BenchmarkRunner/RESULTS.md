...
| **Database** | 1,600ms (6.3x) | 260ms (6.4x) | 510ms (4.7x) | 2,120ms (11.6x) | 570ms (2.7x) | 150ms (7.5x) | 350ms (4.2x) | 620ms (2.3x) | 1,960ms (6.0x) | 480ms (3.1x) | 60ms (1.7x) | 440ms (7.8x) | 4,320ms (24.4x) | 100ms (7.8x) | ❌ | ❌ | 740ms (3.2x) | 2,320ms (6.8x) | ❌ | ❌ | ❌ | ❌ |
...
- **ClickHouse**: 17/22 queries successful (77.3% success rate)
  - 5 failures
- **Database**: 16/22 queries successful (72.7% success rate)
  - 6 failures
...
- **Average execution time (Database)**: 1,039ms
