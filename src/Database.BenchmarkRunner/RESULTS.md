...
| **Database** | 1,990ms (6.5x) | 300ms (5.6x) | 650ms (4.1x) | 910ms (4.2x) | 680ms (2.8x) | 110ms (5.6x) | 380ms (4.0x) | 730ms (2.3x) | 2,090ms (5.7x) | 560ms (3.3x) | 80ms (2.0x) | 510ms (8.3x) | 4,490ms (21.4x) | 120ms (8.6x) | 180ms (17.6x) | 240ms (8.2x) | 760ms (2.9x) | 2,260ms (6.1x) | 780ms (2.9x) | ❌ | ❌ | ❌ |
...
- **Average execution time (Database)**: 938ms
