...
| **Database** | 1,540ms (6.1x) | ❌ | 400ms (3.6x) | ❌ | 1,340ms (6.4x) | 110ms (5.7x) | 3,380ms (40.2x) | 240ms (1.1x) | ❌ | 950ms (6.2x) | 570ms (15.0x) | 440ms (7.7x) | 4,420ms (25.0x) | 120ms (9.2x) | ❌ | ❌ | 6,560ms (27.9x) | 5,540ms (16.3x) | ❌ | ❌ | ❌ | ❌ |
...
- **Average execution time (Database)**: 1,970ms
